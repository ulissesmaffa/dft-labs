...
spyParseTextMessageTagFile("./sg_results/santiago/top_santiago_cpu/dft/dft_best_practice/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(64,"./sg_results/santiago/top_santiago_cpu/dft/dft_best_practice/spyglass.vdb");
