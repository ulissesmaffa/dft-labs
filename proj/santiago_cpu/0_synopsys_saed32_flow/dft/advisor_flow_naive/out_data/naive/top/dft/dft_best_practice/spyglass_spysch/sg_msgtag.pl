...
spyParseTextMessageTagFile("./out_data/naive/top/dft/dft_best_practice/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(51,"./out_data/naive/top/dft/dft_best_practice/spyglass.vdb");
