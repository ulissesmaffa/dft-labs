...
spyParseTextMessageTagFile("./out_data/naive_seq/top/dft/dft_scan_ready/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(42,"./out_data/naive_seq/top/dft/dft_scan_ready/spyglass.vdb");
