set_messages -log out_data/naive_atpg.log -replace -level expert

read_netlist $STD_VERILOG_PATH_SETUP
read_netlist inp_data/netlist/top_comb.v
...
write_patterns ./out_data/naive_pats.stil -format stil -replace
write_faults   ./out_data/naive.faults -all -replace
